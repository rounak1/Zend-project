...
class Module {
    ...
    public function onBootstrap(MvcEvent $e) {
        ...
        $eventManager->attach('route', array($this, 'SeekerCheck'), 2);
    }

    public function SeekerCheck(MvcEvent $e) {
            ...
            if ($module == 'Seeker') {
                ...
                if (!strpos($controller, "Registration")) {
                    ...
                    $e->getApplication()->getEventManager()->getSharedManager()->attach('Zend\Mvc\Controller\AbstractActionController', 'dispatch', function($e) {
                        ...
                        $controller->layout('layout/seeker');
                        $router = $sm->get('router');
                        $request = $sm->get('request');
                        // check auth...
                        $response = $e->getResponse();
                        ...
                        if ($users->user_type != $configs['config_user_type']['seeker']) {
